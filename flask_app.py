...
#         prompt_inbuilt = """You are a world class expert for generating questions based on provided context. 
#         and you will answer question only based on the given context."""
#         result = conversation_chain.run(prompt_inbuilt+prompt)
